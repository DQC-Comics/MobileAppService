...
namespace DqccomicsMobileapiService
{
    public static partial class HeroesExtensions
    {
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<DqccomicsMobileapiService.Models.ApiHeroLimited>> result = await operations.GetHeroesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
